...
use cloudstate_runtime::{
  ...
  extensions::cloudstate::{
    JavaScriptSpans, ReDBCloudstate, TransactionContext,
  },
...
use crate::{
  cloudstate_runner::module_loader::CloudstateModuleLoader,
  CloudstateFetchPermissions,
};
...
pub async fn execute_script_internal(
  ...
  let js_runtime = initialize_cloudstate_runtime(reciever);
...
pub async fn run_script(
  ...
  let transaction_context =
    TransactionContext::new(cs.clone(), blob_storage.clone());
