...
pub trait CloudstateBlobStorage {
    ...
    fn put_blob(&mut self, blob_id: &str, blob_data: CloudstateBlobValue) -> Result<(), Error>;
    fn delete_blob(&mut self, blob_id: &str) -> Result<(), Error>;
